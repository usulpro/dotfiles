...
# User name
# (this name will be ommited in the prompt)
local_username="usulpro"
...
function prompt_command() {
	...
	# Format prompt
	first_line="$user_prompt$host_prompt$login_delimiter$GREEN\w$NOCOLOR$git_prompt$venv_prompt"
